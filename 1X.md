...
me and what I love to do can be found [here](/ABOUT).
...
Keep that in mind when you start exploring this webpage. I hope you like it!
...
classes dataset splitting methods are more often than not overlooked and uniform random sampling
is the standard go-to solution to split the data into training,test and validation. 
...
In parallel to the annotation, I started working on the development side. 
I normally experience that starting with relatively simple and tested architectures
which you modify and tailor to the specific applications is the best starting point
for any project. 
