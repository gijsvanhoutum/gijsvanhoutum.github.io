...
Working and completing a PhD has however kept me from it. This is my new, long overdue, 
webpage I created in response to your opportunity. This specific page is made specifically 
for you and can only be accesed if you know the URL. Keep that in mind when you start 
exploring this webpage. I hope you like it! The startpage can be found [here](https://gijsvanhoutum.github.io/).
From there you can figure more out about me, my papers and projects.
...
my project are pilot projects for industrial companies in the manufacturing
...
**I have also added a samll section on my current and most important work at the end 
...
A interesting example is the case when researchers changed the orientation of the objects in
the Imagenet dataset and measured if state-of-the-art classifiers were still able to classify them
correctly. 
...
**The video below shows my new adaptive model segmen**
